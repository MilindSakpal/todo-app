...
const SEED_DATA: TimesheetEntry[] = [
  // Today
  {
    id: "1",
    taskName: "Morning Standup",
    project: "Intellysis Portal",
    category: "Meeting",
    startTime: "09:00",
    endTime: "09:30",
    status: "Completed",
  ...
  {
    id: "3",
    taskName: "API Integration — Auth Module",
  ...
  {
    id: "4",
    taskName: "Unit Tests for Payment Flow",
    project: "QA Suite",
    category: "Testing",
    startTime: "15:45",
    endTime: "17:15",
  ...
  {
    id: "5",
    taskName: "Sprint Retrospective Notes",
  ...
  {
    id: "16",
    taskName: "Stakeholder Presentation",
    project: "Client Dashboard",
    category: "Meeting",
    startTime: "14:00",
    endTime: "15:30",
  ...
  {
    id: "17",
    taskName: "Research: Next.js 15 Migration",
    project: "Intellysis Portal",
    category: "Research",
    startTime: "09:00",
    endTime: "11:30",
